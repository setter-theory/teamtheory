...
function shell(content, active='home'){
  ...
  return `<div class="topbar"><div class="brand"><img class="brand-icon" src="./icons/icon-192.png?v=0.6" alt=""><div><h1>TEAM Theory</h1><div class="team-name">${esc(team)}</div></div><div class="version">Prototype 0.7</div></div></div>
...
function welcomeView(){
 return `<main class="onboarding"><img class="welcome-app-icon" src="./icons/icon-512.png?v=0.6" alt="TEAM Theory"><h1>TEAM Theory</h1><p>教わるから、考えるへ。</p><div class="welcome-version">Version 0.7</div><div class="welcome-card"><h2>チームで始める</h2><p>代表者はチームを作成。選手は招待コードで参加します。</p><button class="btn primary wide" onclick="go('createTeam')">チームを作る</button><button class="btn secondary wide" onclick="go('joinTeam')">コードで参加する</button></div></main>`;
}
